...
import { User, Mail, Lock, ArrowRight, UserCircle2 } from "lucide-react";
...
const JobSeekerRegistration = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: "تم إنشاء الحساب بنجاح! 🎉", description: "أكمل ملفك الشخصي للحصول على فرص أفضل" });
    navigate("/dashboard");
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4" dir="rtl">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">إنشاء حساب باحث عن عمل</h1>
