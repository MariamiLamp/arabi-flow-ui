...
import { UserCheck, Mail, Lock, ArrowRight, UserCircle2 } from "lucide-react";
...
const HRRegistration = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: "تم إنشاء حساب HR بنجاح! 🎉", description: "أكمل ملفك الشخصي للوصول لجميع المميزات" });
    navigate("/hr");
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4" dir="rtl">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">إنشاء حساب مسؤول توظيف</h1>
          <p className="text-muted-foreground text-sm">سجّل الآن وأكمل ملفك الشخصي لاحقاً</p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input id="firstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="الاسم الأول" className="pr-10" required />
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <Select value={gender} onValueChange={setGender} dir="rtl">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="rather-not-to-say">{t("common.ratherNotToSay")}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
